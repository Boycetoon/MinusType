...
![](image/v2-abc80008594c0bcc6213b4903dde390c_720w.jpg)
...
![](image/v2-15f0c8f37220f00a78e02b8c0befe118_720w.jpg)
然后打开点要素的属性表，新建两个字段命名为X和Y，浮点类型，精度为10，小数位数6。分别进行计算几何计算点的经度和纬度。
![](image/v2-c60a9e4f9258f913497125020963b54e_720w.jpg)
最后将属性表导出，可以存成csv格式，然后在Excel中整理并转存成xlsx格式。
![](image/v2-d566d809a8515c516e660adb8ed21f76_720w.jpg)
2.使用Python进行批量获取
...
- ### 3.一些需要注意的地方
  ...
  ![](image/v2-6f60e3f8c0b0f3d9ea56c647a123da36_720w.jpg)
